...
//                vxCreateImage(context, img_w, img_h, VX_DF_IMAGE_U8), // 2:grad_x
//                vxCreateImage(context, img_w, img_h, VX_DF_IMAGE_U8), // 3:grad_y
        };
        ...
        if (status == VX_SUCCESS)
        {
            ...
            if (vxGetStatus((vx_reference)graph) == VX_SUCCESS)
            {
                vx_node nodes[] = {
                    ...
                    vxFWriteImageNode(graph, images[2], "non_tiling_sobel_gradx_lena_1024x1024.pgm"),
                    vxFWriteImageNode(graph, images[3], "non_tiling_sobel_grady_lena_1024x1024.pgm"),
                };
