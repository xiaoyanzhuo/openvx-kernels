        ...
        if (status == VX_SUCCESS)
        {
            ...
            if (vxGetStatus((vx_reference)graph) == VX_SUCCESS)
            {
                vx_node nodes[] = {
                    ...
                    vxFWriteImageNode(graph, images[2], "non_tiling_channel_extract_r_lena_512x512.pgm"),
                    vxFWriteImageNode(graph, images[3], "non_tiling_channel_extract_g_lena_512x512.pgm"),
                    vxFWriteImageNode(graph, images[4], "non_tiling_channel_extract_b_lena_512x512.pgm"),
                };
