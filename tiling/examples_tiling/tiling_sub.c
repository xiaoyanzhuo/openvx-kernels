...
vx_node vxTilingSubNode(vx_graph graph, vx_image in0, vx_image in1, vx_image out)
{
    vx_reference params[] = {
        (vx_reference)in0,
        (vx_reference)in1,
...
int main(int argc, char *argv[])
{
    ...
    if (vxGetStatus((vx_reference)context) == VX_SUCCESS)
    {
        ...
        vx_image images[] = {
                ...
                vxCreateImage(context, img_w, img_h, VX_DF_IMAGE_U8),// 3:sub
        };
        vx_float32 a = 0.5f;
        ...
        if (status == VX_SUCCESS)
        {
            ...
            if (vxGetStatus((vx_reference)graph) == VX_SUCCESS)
            {
                vx_node nodes[] = {
                    ...
                    vxTilingSubNode(graph, images[1], images[2], images[3]),
                    vxFWriteImageNode(graph, images[3], "tiling_sub_lena_512x512.pgm"),
                };
