...
vx_node vxTilingColorConvertNode(vx_graph graph, vx_image in, vx_image out)
{
    vx_reference params[] = {
        (vx_reference)in,
        (vx_reference)out,
...
int main(int argc, char *argv[])
{
    ...
    if (vxGetStatus((vx_reference)context) == VX_SUCCESS)
    {
        ...
        vx_image images[] = {
                ...
                vxCreateImage(context, img_w, img_h, VX_DF_IMAGE_IYUV), //2:yuv
        };
        ...
        if (status == VX_SUCCESS)
        {
            ...
            if (vxGetStatus((vx_reference)graph) == VX_SUCCESS)
            {
                vx_node nodes[] = {
                    ...
                    vxTilingColorConvertNode(graph, images[1], images[2]),
                    vxFWriteImageNode(graph, images[2], "tiling_color_convert_lena_512x512.pgm"),
                };
