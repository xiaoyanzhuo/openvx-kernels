...
vx_node vxTilingMedianNode(vx_graph graph, vx_image in, vx_image out, vx_uint32 width, vx_uint32 height)
{
    vx_reference params[] = {
        (vx_reference)in,
        (vx_reference)out,
...
int main(int argc, char *argv[])
{
    ...
    if (vxGetStatus((vx_reference)context) == VX_SUCCESS)
    {
        ...
        vx_image images[] = {
                ...
                vxCreateImage(context, img_w, img_h, VX_DF_IMAGE_U8), // 2:median
        };
        ...
        if (status == VX_SUCCESS)
        {
            ...
            if (vxGetStatus((vx_reference)graph) == VX_SUCCESS)
            {
                vx_node nodes[] = {
                    ...
                    vxTilingMedianNode(graph, images[1], images[2], 3, 3),
                    vxFWriteImageNode(graph, images[2], "tiling_median_lena_512x512.pgm"),
                };
